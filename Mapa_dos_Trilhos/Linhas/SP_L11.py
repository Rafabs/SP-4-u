...
ARQUITETURA:
    Mapa_dos_Trilhos/Linhas/SP_L11.py
"""
import os
import json
import sys
...
def line11():
    try:
        ...
        print(f"Executando linha 11: {sys.executable} {script_path}")
        ...
        print("Linha 11 executada com sucesso!")
        return True
        
    except subprocess.CalledProcessError as e:
        error_msg = f"Erro ao executar linha 11:\n{e.stderr}"
        print(error_msg)
        logging.error(error_msg)
        return False
    except Exception as e:
        error_msg = f"Erro inesperado em line11: {str(e)}"
        print(error_msg)
        logging.error(error_msg)
        return False
...
class MapaLinhaWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('Mapa_dos_Trilhos/Favicon/11_coral.ico'))
