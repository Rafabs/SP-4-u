...
def line11():
    try:
        ...
        print(f"Iniciando linha 11 com: {python_exe} {script_path}")
        
        # Verifica se o arquivo existe
        if not script_path.exists():
            raise FileNotFoundError(f"Arquivo da linha 11 não encontrado: {script_path}")
        ...
        print(f"Erro ao abrir linha 11: {str(e)}")
        logging.error(f"Erro em line11: {str(e)}")
        raise
