...
def line3():
    try:
        ...
        print(f"Iniciando linha 3 com: {python_exe} {script_path}")
        
        # Verifica se o arquivo existe
        if not script_path.exists():
            raise FileNotFoundError(f"Arquivo da linha 3 não encontrado: {script_path}")
        ...
        print(f"Erro ao abrir linha 3: {str(e)}")
        logging.error(f"Erro em line3: {str(e)}")
        raise
