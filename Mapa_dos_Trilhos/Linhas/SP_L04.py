...
__modified__    = "16/07/2025 01:52"

DESCRITIVO:
MÃ³dulo de funcionalidades especÃ­ficas
ARQUITETURA:
    Mapa_dos_Trilhos/Linhas/SP_L04.py
"""
import os
import json
import sys
...
class MapaLinhaWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.status_linha = self.status_manager.get_line_status("Linha 4 - Amarela")
    ...
    def create_header_texts(self):
        ...
        self.date_text.setDefaultTextColor(QColor("#000000"))
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_Escape:
            with open('Mapa_dos_Trilhos/log.log', 'a', encoding='utf-8') as f:
                f.write(f"{datetime.now()} - Fechando Linha 4 - Amarela\n")
            self.close()
