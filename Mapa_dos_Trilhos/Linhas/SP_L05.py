...
def line5():
    try:
        ...
        print(f"Iniciando linha 5 com: {python_exe} {script_path}")
        
        # Verifica se o arquivo existe
        if not script_path.exists():
            raise FileNotFoundError(f"Arquivo da linha 5 não encontrado: {script_path}")
        ...
        print(f"Erro ao abrir linha 5: {str(e)}")
        logging.error(f"Erro em line5: {str(e)}")
        raise
