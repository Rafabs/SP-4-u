...
ARQUITETURA:
    Mapa_dos_Trilhos/Linhas/SP_L08.py
"""
import os
import json
import sys
...
def line8():
    try:
        ...
        print(f"Executando linha 8: {sys.executable} {script_path}")
        ...
        print("Linha 8 executada com sucesso!")
        return True
        
    except subprocess.CalledProcessError as e:
        error_msg = f"Erro ao executar linha 8:\n{e.stderr}"
        print(error_msg)
        logging.error(error_msg)
        return False
    except Exception as e:
        error_msg = f"Erro inesperado em line8: {str(e)}"
        print(error_msg)
        logging.error(error_msg)
        return False
...
class MapaLinhaWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Linha 8 - Diamante")
        self.setWindowIcon(QIcon('Mapa_dos_Trilhos/Favicon/8_diamante.ico'))
