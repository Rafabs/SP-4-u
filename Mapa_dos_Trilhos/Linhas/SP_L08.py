...
def line8():
    try:
        ...
        print(f"Iniciando linha 8 com: {python_exe} {script_path}")
        
        # Verifica se o arquivo existe
        if not script_path.exists():
            raise FileNotFoundError(f"Arquivo da linha 8 não encontrado: {script_path}")
        ...
        print(f"Erro ao abrir linha 8: {str(e)}")
        logging.error(f"Erro em line8: {str(e)}")
        raise
