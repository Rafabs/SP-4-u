...
def line2():
    try:
        ...
        print(f"Iniciando linha 2 com: {python_exe} {script_path}")
        
        # Verifica se o arquivo existe
        if not script_path.exists():
            raise FileNotFoundError(f"Arquivo da linha 2 não encontrado: {script_path}")
        ...
        print(f"Erro ao abrir linha 2: {str(e)}")
        logging.error(f"Erro em line2: {str(e)}")
        raise
