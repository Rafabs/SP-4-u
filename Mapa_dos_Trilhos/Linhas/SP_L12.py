...
def line12():
    try:
        ...
        print(f"Iniciando linha 12: {python_exe} {script_path}")
        
        # Verifica se o arquivo existe
        if not script_path.exists():
            raise FileNotFoundError(f"Arquivo da linha 12 encontrado: {script_path}")
        ...
        print(f"Erro ao abrir linha 12: {str(e)}")
        logging.error(f"Erro em line12: {str(e)}")
        raise
