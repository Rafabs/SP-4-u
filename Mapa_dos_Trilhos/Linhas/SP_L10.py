...
def line10():
    try:
        ...
        print(f"Iniciando linha 10 com: {python_exe} {script_path}")
        
        # Verifica se o arquivo existe
        if not script_path.exists():
            raise FileNotFoundError(f"Arquivo da linha 10 não encontrado: {script_path}")
        ...
        print(f"Erro ao abrir linha 10: {str(e)}")
        logging.error(f"Erro em line10: {str(e)}")
        raise
