...
__modified__    = "16/07/2025 01:56"

DESCRITIVO:
MÃ³dulo de funcionalidades especÃ­ficas
ARQUITETURA:
    Mapa_dos_Trilhos/Linhas/SP_L15.py
"""
import os
import json
import sys
...
class MapaLinhaWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Linha 15 - Prata")
    ...
    def setup_ui(self):
        ...
        self.status_linha = self.status_manager.get_line_status("Linha 15 - Prata")
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_Escape:
            with open('Mapa_dos_Trilhos/log.log', 'a', encoding='utf-8') as f:
                f.write(f"{datetime.now()} - Fechando Linha 15 - Prata\n")
            self.close()
